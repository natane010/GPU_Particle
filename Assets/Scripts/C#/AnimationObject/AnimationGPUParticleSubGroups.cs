...
public class AnimationGPUParticleSubGroups : MonoBehaviour
{
    public string Label = "";
    private List<AnimationParticleTarget> _targets = new List<AnimationParticleTarget>();
    ...
    public void AddTarget(AnimationParticleTarget target)
    {
    ...
    public void AddTargets(List<AnimationParticleTarget> targets)
    {
        _targets.AddRange(targets);
    }

    public void RemoveTarget(AnimationParticleTarget target)
    {
        if (!_targets.Contains(target))
        {
            _allCount = -1;
